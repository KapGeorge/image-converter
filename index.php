...
<body class="min-h-screen flex flex-col items-center justify-center text-white">
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data" class="space-y-5">
            <div>
                ...
                <label for="file-upload"
                    class="flex items-center justify-center w-full px-4 py-3 bg-white text-blue-700 font-semibold rounded-lg shadow-md hover:bg-blue-100 cursor-pointer transition">
                    📁 Choose Files
                </label>
                <input id="file-upload" type="file" name="images[]" multiple accept="image/*" required class="hidden">
            </div>
    ...
    <footer class="mt-10 text-center">
        <p class="text-sm text-gray-500">© <?= date('Y') ?> Image Converter. All rights reserved.</p>
        <p class="text-sm text-gray-500">Made with ❤️ by <a href="george" class="text-blue-500 hover:underline">George</a></p>
    </footer>
    <!-- <link rel="script" id="simple-styles" href="/assets/script.js" media="all"> -->
